...
$("help").onclick = () => {
  ...
  state.paused = true;
  helpOpen = true;
  $("modal-title").textContent = "How the shift works";
  $("modal-copy").innerHTML = shiftHelp;
  $("resume").textContent = "Back to the counter";
  $("overlay").hidden = false;
  document.querySelector(".shell").inert = true;
  $("resume").focus();
};
